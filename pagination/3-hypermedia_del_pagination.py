...
class Server:
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        ...
        Ensures no items are skipped even if rows were deleted between queries.

        Args:
            index (int): Start index of the page. Defaults to None.
            page_size (int): Number of items per page. Defaults to 10.

        Returns:
            Dict: index, next_index, page_size, and data for the current page.
        """
